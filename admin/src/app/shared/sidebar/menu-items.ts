...
export const ROUTES: RouteInfo[] = [
  ...
  },
  {
    ...
    submenu: [
      { path: '/users/list/admin', title: 'Admin', icon: 'fa fa-users', class: '', label: '', labelClass: '', extralink: false, submenu: [] },
      { path: '/users/list/seller', title: 'Seller', icon: 'fa fa-users', class: '', label: '', labelClass: '', extralink: false, submenu: [] },
      { path: '/users/list/user', title: 'Customer', icon: 'fa fa-users', class: '', label: '', labelClass: '', extralink: false, submenu: [] },
      { path: '/users/list/courier', title: 'Courier', icon: 'fa fa-users', class: '', label: '', labelClass: '', extralink: false, submenu: [] },
